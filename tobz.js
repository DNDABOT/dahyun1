...
module.exports = tobz = async (tobz, message) => {
      ...
      if (chats == 'dek posting'){
        ...
        function isReg(obj){
            if (obj === true){
                ...
                return tobz.reply(from, `Anda belum tedaftar didatabase a\nUntuk mendaftar kirim ${prefix}daftar /nama/umur\n\nContoh format: ${prefix}daftar /Ambrose/18\n\nCukup dengan menggunakan nama depan/panggilan saja/umur dianjurkan 18+`, id) //if user is not registered
            }
        }
	...
	const sotoy = [
        ...
        const mess = {
            wait: '*[ WAIT ]* tunggu sebentar a',
            magernulissatu: '[ WAIT ] tunggu sebentar a',
            error: {
	...
	if (isGroupMsg && AntiStickerSpam && !isGroupAdmins && !isAdmin && !isOwner){
        ...
        if(!isCmd && isKasar && isGroupMsg && isBadword && !isGroupAdmins) { 
            ...
            if(isBadwordMsg(serial)) return
                ...
                if (body === '.unbanchat') {
                    if (!isOwner) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh owner *DA BOT*!', id)
        ...
        case prefix+'slightning':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            tobz.reply(from, `[WAIT] tunggu sebentar a ± 1 min!`, id)
            if (isMedia && type === 'image') {
                const mediaData = await decryptMedia(message, uaOverride)
        ...
        case prefix+'lovemessage':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}lovemessage <teksnya>, contoh ${prefix}lovemessage Ambrose`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'romance':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}romance <teksnya>, contoh ${prefix}romance Ambrose`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'party':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}party <teksnya>, contoh ${prefix}party Ambrose`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'silk':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}silk <teksnya>, contoh ${prefix}silk Ambrose`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'thunder':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}thunder <teksnya>, contoh ${prefix}thunder Ambrose`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'pornhub':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /ambrose /dahyun`, id)
            ...
            if (argz.length >= 2) {
                ...
                await tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /ambrose /dahyun`, id)
            }
            break
        case prefix+'glitch':
            if(isReg(obj)) return
        ...
        case prefix+'daftar':
                ...
                const umurnye = argz[2]
                    ...
                    if(umurnye >= 50) return await tobz.reply(from, 'Tidak dapat terverifikasi, umur terlalu tua maksimal 50!', id)
...
${desc}`)
        ...
        case prefix+'tts':
            ...
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            try {
                if (args.length === 1) return tobz.reply(from, 'Kirim perintah .tts <kode bahasa> <teksnya>, Contoh .tts id Ambrose\nUntuk melihat kode bahasa ketik .bahasa')
                var dataBhs = args[1]      
        ...
        case prefix+'ownerbot':
            ...
            tobz.reply(from, 'Itu nomor owner bot, kalau chat harus sopan dan janganb chat P!', id)
            break
        ...
        case prefix+'simi':
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh Admin DABOT', id) // Hanya Admin yang bisa mengaktifkan
            if (args.length === 1) return tobz.reply(from, 'Pilih enable atau disable!', id)
        ...
        case prefix+'left':
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (!isGroupAdmins, !isOwner) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh admin dan owner!', id)
            if (args.length === 1) return tobz.reply(from, 'Pilih enable atau disable!', id)
            if (args[1].toLowerCase() === 'aktif') {
                left.push(chat.id)
                ...
                tobz.reply(from, 'Pilih aktif atau nonaktif a!', id)
            }
            break
        ...
        case prefix+'pinterest':
            ...
            tobz.reply(from, mess.wait, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah .pinterest <query>, Contoh : .pinterest naruto', id)
        ...
        case prefix+'loli':
            ...
            tobz.sendFileFromUrl(from, loly.result, 'loli.jpeg', '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'shota':
            if(isReg(obj)) return
            ...
            tobz.sendFile(from, img, "shota.jpg", `*nih a...*`, id)
            limitAdd(serial)
                    }) 
                .catch(
                    (error) => {
        ...
        case prefix+'randomnekonime':
            ...
            tobz.sendFileFromUrl(from, nekon.result, `Nekonime${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        // MFARELS
        ...
        case prefix+'animengewe':
            ...
            tobz.sendImage(from, trapnim.result, `RandomTrapnime${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'hentai':
            if(isReg(obj)) return
            ...
            tobz.sendImage(from, henta.result, `RandomHentai${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'animengewe2':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            tobz.reply(from, mess.wait, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            ...
            tobz.sendImage(from, nsfwn.result, `NsfwNeko${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'randomanime':
            ...
            tobz.sendFileFromUrl(from, ranimen.result, `RandomAnime${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'blowjobanime':
            ...
            tobz.sendFileFromUrl(from, rblow.result, `RandoBlow${ext}`, '*nih a...*', id)
            break
        case prefix+'randomhug':
            ...
            tobz.sendFileFromUrl(from, rhug.result, `RandomHug${ext}`, '*nih a...*', id)
            break
        case prefix+'randomcry':
            ...
            tobz.sendFileFromUrl(from, rcry.result, `RandomCry${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        case prefix+'ciumananime':
            ...
            tobz.sendFileFromUrl(from, rkiss.result, `RandomKiss${ext}`, '*nih a...*', id)
            await limitAdd(serial)
            break
        ...
        case prefix+'nhder':
            ...
            if (args.length >=2){
                ...
                tobz.sendText(from, 'ketik .nhder beserta dengan kode hentainya a')
            }
            break
...
🌐️ *URL*: ${url}`
        ...
        case prefix+'shopee':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}shopee <nama barang>, Contoh : ${prefix}shopee Album dahyun`)
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'wait':
            ...
            if (isMedia && type === 'image' || quotedMsg && quotedMsg.type === 'image') {
                ...
                tobz.sendFileFromUrl(from, tutor, 'Tutor.jpg', 'Nih contoh a!', id)
            }
            break
        ...
        case prefix+'quoteit':
            ...
            if (argz.length >= 4) {
                ...
                await quotemaker(quotes, author, theme).then(amsu => {
                    limitAdd(serial)
                    tobz.sendFile(from, amsu, 'quotesmaker.jpg','nih a...').catch(() => {
                       tobz.reply(from, mess.error.Qm, id)
                    })
                })
            } else {
                tobz.reply(from, 'Kirim perintah .quoteit /nama/teksnya/temanya\nContoh : .quoteit /dahyun cantik/Ambrose/Laut', id)
            }
            break
        ...
        case prefix+'gachacewek':
            ...
            tobz.sendFileFromUrl(from, pep, 'pptl.jpg', 'Follow ig : https://www.instagram.com/deniambrose_', message.id)
            await limitAdd(serial)
            break
        case prefix+'kucing':
            if(isReg(obj)) return
        ...
        case prefix+'lirik':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length == 1) return tobz.reply(from, 'Kirim perintah *.lirik [optional]*, contoh *.lirik cry for me*', id)
        ...
        case prefix+'tampar':
            ...
            tobz.sendTextWithMentions(from, '@' + person + ' Cie nampol ' + slap)
            limitAdd(serial)
            break
        ...
        case prefix+'addbadword':
            if (!isAdmin) return tobz.reply(from, `Perintah ini hanya bisa di gunakan oleh Admin DABOT!`, id)
        ...
        case prefix+'okickall':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (!isOwner) return tobz.reply(from, 'Perintah ini hanya untuk Admin DABOT', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
        ...
        case prefix+'oadd':
            ...
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin DABOT', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
            try {
        ...
        case prefix+'sider':
            ...
            try {
                ...
                console.log(err)
                tobz.reply(from, `Maaf, Belum Ada Yang Membaca Pesan DABOT atau Mereka Menonaktifkan Read Receipts`, id)    
            }
            break
            ...
            if (!isAdmin, !isOwner) return tobz.reply(from, `Perintah hanya dapat digunakan oleh member *premium*!`, id)
                    ...
                    if(jmla > 20) return await tobz.reply(from, `Maximal  20!`, id)
                        ...
                        if (found !== false) {
                            ...
                            const result = `Tambah limit sukses dengan\nSerial Number : ${SN}\nPada ${moment().format('DD/MM/YY HH:mm:ss')}
╔═══✪〘 TAMBAH LIMIT 〙✪═══
...
╚═══✪〘 DABOT 〙✪═══════`
	...
	//list menu
        ...
        case prefix+'help':
            ...
            break
        case prefix+'dagroup':
            tobz.reply(from, `Link Group DABOT : https://chat.whatsapp.com/DzRKpHZgXsK1416iXMGubM masuk ya a${pushname}`, id)
            break
...
//BY SYAHRUL SARIZ
        case prefix+'nulis':
            await tobz.reply(from, `Perintah nulis terdapat dua versi\nVersi 1 Menggunakan Nama,kelas dan tanggal\nUntuk menggunakannya ketik .nulis1\n\nVersi 2 Hanya tulisan saja\nUntuk menggunakannya ketik .nulis2`, id)
            break
        case prefix+'nulis1':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}nulis1 /nama/kelas/teksnya, contoh ${prefix}nulis1 /Ambrose/13TKR2/Ulangan harian`, id)
            argz = body.trim().split('/')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
