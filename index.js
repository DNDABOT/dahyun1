...
const start = async (tobz = new Client()) => {
        ...
        tobz.onIncomingCall(( async (call) => {
            await tobz.sendText(call.peerJid, 'Telpon terdeteksi, BOT memiliki sistem block otomatis jika ditelpon\nMaaf a anda diblock oleh bot, Chat owner untuk membuka block\nOwner number : https://wa.me/6285747852482')
